...
def DecisionTree():
    ...
    if (h == 'yes'):
        ...
        lab1.delete("1.0", END)
        pred = str((accuracy_score(y_test, y_pred) *100))
        lab1.insert(END, pred)
    else:
        t1.delete("1.0", END)
        t1.insert(END, "Not Found")
        lab1.delete("1.0", END)
        lab1.insert(END, "Not Found")
def randomforest():
    ...
    if (h == 'yes'):
        ...
        lab2.delete("1.0", END)
        pred = str((accuracy_score(y_test, y_pred) * 100))
        lab2.insert(END, pred)
    else:
        t2.delete("1.0", END)
        t2.insert(END, "Not Found")
        lab2.delete("1.0", END)
        lab2.insert(END, "Not Found")
def NaiveBayes():
    ...
    if (h == 'yes'):
        ...
        lab3.delete("1.0", END)
        pred = str((accuracy_score(y_test, y_pred) * 100))
        lab3.insert(END, pred)
    else:
        t3.delete("1.0", END)
        t3.insert(END, "Not Found")
        lab3.delete("1.0", END)
        lab3.insert(END, "Not Found")
# gui_stuff------------------------------------------------------------------------------------
root = Tk()
...
lr.grid(row=10, column=3)
main = Button(root, text="Enter",command=lambda: [DecisionTree(), randomforest(), NaiveBayes()], bg="green", fg="yellow")
main.grid(row=11, column=3)
#textfileds
lab1 = Text(root, height=1, width=10, bg="white", fg="black")
lab1.grid(row = 15, column = 2, padx=10)
lab2 = Text(root, height=1, width=10, bg="white", fg="black")
lab2.grid(row = 17, column = 2, padx=10)
lab3 = Text(root, height=1, width=10, bg="white", fg="black")
lab3.grid(row = 19, column = 2, padx=10)
